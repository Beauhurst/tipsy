...
(function($) {
    ...
    Tipsy.prototype = {
        show: function() {
            ...
            if ( title && this.enabled && this.$element.closest ( document.documentElement ).length ) {
                ...
                if (gravity.length == 2) {
                    if (gravity.charAt(1) == 'w') {
                        tp.left = pos.left + pos.width / 2 - parseInt ( $tip.css('padding-left') );
                    } else {
                        tp.left = pos.left + pos.width / 2 - actualWidth + parseInt ( $tip.css('padding-right') );
                    }
                }
